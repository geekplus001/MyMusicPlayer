...
//			myMusicListFragment.loadData();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.mylovesong:
				Intent intent = new Intent(this,MyLoveMusicListActivity.class);
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
		...
		private final String[] TITLES = {getString(R.string.part1), getString(R.string.part2)};
